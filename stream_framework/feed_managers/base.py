...
class Manager(object):
    ...
    **Example** ::
    ...
    def follow_user(self, user_id, target_user_id, asynch=True):
        '''
        ...
        :param asynch: controls if the operation should be done via celery
        '''
        self.follow_many_users(user_id, [target_user_id], asynch)

    def unfollow_user(self, user_id, target_user_id, asynch=True):
        '''
        ...
        :param asynch: controls if the operation should be done via celery
        '''
        self.unfollow_many_users(user_id, [target_user_id], asynch)

    def follow_many_users(self, user_id, target_ids, asynch=True):
        '''
    ...
    def unfollow_many_users(self, user_id, target_ids, asynch=True):
        '''
